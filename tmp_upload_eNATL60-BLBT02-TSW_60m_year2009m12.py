...
for day in np.arange(1,31):
    dd="{:02d}".format(day) 
    filename = "eNATL60-BLBT02_y2009m12d"+str(dd)+".1d_TSW_60m.nc"
...
data = {
    "metadata": {
        "title": "eNATL60-BLBT02 TSW 60m y2009m12",
        "upload_type": "dataset",
        "publication date":"2023-12-01",
        "description":"Daily files of eNATL60-BLBT02 Temperature Salinity and Vertical velocity fields at 60m for year 2009 month 12",
        "creators": [
